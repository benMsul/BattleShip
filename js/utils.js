...
(function (global) {
    ...
    global.utils = {
        CELL_SIZE: 60,
        // retourne la position (démarre à 1) du nœud passé en paramètre dans son parent
        eq: function (node) {
        ...
        // créer un tableau à deux dimension, chaque élément du tableau est définie à la valeur (optionnelle) "value" (vaut 0 par défaut)
